...
import { CollectionReference, doc, DocumentData, addDoc, getDocs, getDoc, updateDoc, setDoc, deleteDoc } from 'firebase/firestore';
...
export class ProductService {
  ...
  async preBuildData() {
    ...
    for (let key of Object.keys(products)) {
      await setDoc(doc(this.productsRef, key), products[key]);
    }
